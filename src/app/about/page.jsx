export default function About() {
  return (
    ...
    >
      ...
      <div className="w-full h-full overflow-y-auto text-white text-justify text-[28px] font-bold break-words font-['Averia_Serif_Libre'] p-4">
        <p>
        ...
        <p>
          ...
          Estoy lista para empezar, crecer y aportar. ¿Conectamos?
        </p>
      </div>
    </section>
  );
